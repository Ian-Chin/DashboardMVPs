...
import { ALL_CHANNELS, EcomProvider, useEcom } from '../../state/EcomContext.jsx'
      ...
      >
        <div className="flex items-center justify-between px-5 pb-5 pt-5">
          <Link to="/" onClick={onClose} title="All businesses" className="rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-400/50">
            <Logo size={28} tone="dark" subtitle="E-commerce" />
          </Link>
          <button
            type="button"
            onClick={onClose}
            className="rounded-md p-1 text-ink-400 transition hover:bg-ink-900 hover:text-white lg:hidden"
        ...
        <nav className="flex-1 overflow-y-auto px-3 pb-4">
          <p className="px-3 pb-1.5 text-[10px] font-semibold uppercase tracking-[0.14em] text-ink-500">Workspace</p>
          <div className="space-y-0.5">
            {ECOM_NAV.map((item) => (
              ...
              >
                {({ isActive }) => (
                  <>
                    <item.icon size={17} strokeWidth={1.9} className={isActive ? 'text-brand-400' : 'text-ink-400'} />
          ...
          <p className="mt-6 px-3 pb-1.5 text-[10px] font-semibold uppercase tracking-[0.14em] text-ink-500">Elsewhere</p>
          <Link
            to="/restaurants"
            onClick={onClose}
            className="flex items-center gap-2.5 rounded-lg px-3 py-2 text-[14px] font-medium text-ink-300 transition hover:bg-ink-900/60 hover:text-white"
          >
        ...
        <div className="border-t border-ink-900 px-5 py-4">
          <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-ink-500">Connected</p>
          <p className="mt-1.5 text-[13px] font-medium text-ink-100">{store.platform}</p>
